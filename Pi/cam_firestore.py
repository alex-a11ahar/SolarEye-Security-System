...
# Create a Firestore client and reference for PIR sensor data
db = firestore.client()
pir_sensor_ref = db.collection('pir_sensor_data')

# ----------------------
# PIR Sensor and Directories Setup
# ----------------------
...
# ----------------------
# Video Capture, Upload, and Frame Extraction Functions
# ----------------------
def capture_video():
...
def preprocess_frame(frame):
    ...
    frame_normalized = frame_gray / 255.0  # Normalize pixel values
    return (frame_normalized * 255).astype('uint8')

# ----------------------
# Continuous Mode and Motion Handling Functions
# ----------------------
...
def motion_function():
    ...
    # Add motion event to Firestore
    pir_sensor_ref.add(data)
    print("Motion detected and data pushed to Firestore")

    # Run image capture and video capture process
    initial_capture()
    capture_video()
...
def no_motion_function():
    ...
    pir_sensor_ref.add(data)
    print("Motion stopped and data pushed to Firestore")
