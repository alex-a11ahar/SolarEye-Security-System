...
cred = credentials.Certificate('solareye_credentials.json')  # Update with your Firebase credentials
firebase_admin.initialize_app(cred, {
    'storageBucket': 'solareye-security-system.firebasestorage.app'  # Use your Firebase Storage bucket
})
